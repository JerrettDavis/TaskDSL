...
public class CronStringTests
{
    ...
    public void Min_Every15Minutes()
    {
        ...
        var cron = Parser.ToCronString(r);
    ...
    public void Throws_For_NthWeekday_Not_Supported_In_Cron()
    {
        ...
        Assert.Throws<NotSupportedException>(() => Parser.ToCronString(r));
    }
    ...
    public void Unknown_Frequency_Throws_FormatException()
    {
        ...
        Assert.Throws<FormatException>(() => Parser.ToCronString(r));
    }

    [Fact]
    public void Empty_Recurrence_Throws()
    {
        Assert.Throws<ArgumentException>(() => Parser.ToCronString(Recurrence.Empty));
    }
}